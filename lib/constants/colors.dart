...
const backgroundColor = Color.fromARGB(255, 34, 37, 45);
const operationsColor = Color.fromARGB(255, 236, 102, 102);
const numbersColor = Color.fromARGB(255, 255, 255, 255);
const buttonsColor = Color.fromARGB(255, 39, 43, 51);
